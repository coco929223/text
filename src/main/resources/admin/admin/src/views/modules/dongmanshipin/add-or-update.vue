<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="视频编号" prop="shipinbianhao">
					<el-input v-model="ruleForm.shipinbianhao" placeholder="视频编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shipinbianhao" label="视频编号" prop="shipinbianhao">
					<el-input v-model="ruleForm.shipinbianhao" placeholder="视频编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="视频名称" prop="shipinmingcheng">
					<el-input v-model="ruleForm.shipinmingcheng" placeholder="视频名称" clearable  :readonly="ro.shipinmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="视频名称" prop="shipinmingcheng">
					<el-input v-model="ruleForm.shipinmingcheng" placeholder="视频名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="视频分类" prop="shipinfenlei">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="视频分类" prop="shipinfenlei">
					<el-input v-model="ruleForm.shipinfenlei"
						placeholder="视频分类" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.shipinfengmian" label="视频封面" prop="shipinfengmian">
					<file-upload
						tip="点击上传视频封面"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.shipinfengmian" label="视频封面" prop="shipinfengmian">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shipin" label="视频" prop="shipin">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"30px","background":"#4662A1","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.shipin)">预览</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.shipin" label="视频" prop="shipin">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="视频介绍" prop="shipinjieshao">
					<editor 
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else-if="ruleForm.shipinjieshao" label="视频介绍" prop="shipinjieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.shipinjieshao"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shipinjieshao = this.ruleForm.shipinjieshao.replace(reg,'../../../springboot6ygmo/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
