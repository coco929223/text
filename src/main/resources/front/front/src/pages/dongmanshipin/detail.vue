...
<div>
	...
	<div class="detail-preview" :style='{"padding":"0 20px","margin":"0px auto","flexWrap":"wrap","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
		<div class="attr" :style='{"padding":"20px","margin":"20px 0 20px 0","borderColor":"#b2e2fe","display":"flex","justifyContent":"space-between","minHeight":"600px","overflow":"hidden","flexWrap":"wrap","background":"rgba(255,255,255,.3)","borderWidth":"6px","width":"100%","position":"relative","borderStyle":"dotted"}'>
			...
			<div class="info" :style='{"minHeight":"500px","padding":"0px","margin":"0px auto 0 auto","background":"none","width":"48%","height":"auto","order":"2"}'>
				...
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#9dcde9","borderRadius":"0px","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0 0 2px","display":"flex","borderStyle":"dotted","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#666","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>视频编号</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.shipinbianhao}}</div>
				</div>
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#9dcde9","borderRadius":"0px","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0 0 2px","display":"flex","borderStyle":"dotted","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#666","textAlign":"right","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"130px"}'>视频分类</div>
					<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#666","height":"auto"}'>{{detail.shipinfenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"0px 10px","boxShadow":"inset 0px 0px 0px 0px #ddd","margin":"0 0 10px 0","borderColor":"#9dcde9","borderRadius":"0px","background":"linear-gradient(320deg, rgba(204,204,204,.0) 0%, rgba(255,255,255,.9) 80%, rgba(204,204,204,.0) 100%)","borderWidth":"0 0 2px","display":"flex","borderStyle":"dotted","justifyContent":"spaceBetween"}'>
			...
			<div class="hot" :style='{"width":"calc(100% - 0px)","clear":"both","margin":"40px auto","background":"none","height":"auto","order":"6"}'>
			  ...
			  <div :style='{"padding":"10px 10px 0","boxShadow":"0px 0px 0px #eee,inset 0px 0px 0px 0px #fbf5db","borderColor":"#b4ebc7","borderRadius":"0","flexWrap":"wrap","background":"none","borderWidth":"0 0px 0px 0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-between","height":"auto"}'>
			    <div v-for="item in hotList" :key="item" :style='{"cursor":"pointer","padding":"10px","margin":"0 0 10px","background":"#fff","width":"23%","position":"relative","height":"auto"}' @click="toDetail(item)">
			      <img :style='{"cursor":"pointer","padding":"10px","margin":"0 0 4px","borderColor":"#9dcde9","objectFit":"cover","borderRadius":"0px","borderWidth":"6px","display":"block","width":"100%","borderStyle":"dotted","height":"180px"}' :src="baseUrl + (item.shipinfengmian?item.shipinfengmian.split(',')[0]:'')" alt="">
			      <div :style='{"padding":"4px 5px 0","borderColor":"#9dcde9","color":"#333","background":"none","borderWidth":"0 0 1px","lineHeight":"24px","fontSize":"14px","borderStyle":"dotted"}'>{{item.shipinmingcheng}}</div>
			      <div :style='{"padding":"4px 5px 0","borderColor":"#9dcde9","color":"#333","background":"none","borderWidth":"0 0 1px","lineHeight":"24px","fontSize":"14px","borderStyle":"dotted"}'>{{item.shipinfenlei}}</div>
		...
		<video :style='{"padding":"20px 20%","boxShadow":"0px 0px 0px #ddd,inset 0px 0px 0px 0px #e0f8e8","margin":"10px auto","outline":"none","borderColor":"#b2e2fe","borderRadius":"0px","background":"rgba(255,255,255,.3)","borderWidth":"6px","display":"block","width":"100%","borderStyle":"dotted"}' :src="baseUrl +  detail.shipin" controls="controls">
			您的浏览器不支持视频播放
		</video>
    ...
    methods: {
      ...
      getStoreupStatus(){
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'dongmanshipin', userid: localStorage.getItem('userid')}}).then(res => {
      ...
      getDiscussList(page) {
        this.$http.get('discussdongmanshipin/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      submitForm(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            this.$http.post('discussdongmanshipin/add', this.form).then(res => {
              if (res.data.code == 0) {
                this.form.content = '';
                this.getDiscussList(1);
                this.$message({
